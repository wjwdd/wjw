(function($, window, document) {
	...
	jiazaihtml += '<svg width="38" height="38" viewBox="-2 -5 45 45" xmlns="http://www.w3.org/2000/svg" stroke="#22aa12">';
	jiazaihtml += '		<g fill="none" fill-rule="evenodd">';
	jiazaihtml += '			<g transform="translate(1 1)" stroke-width="4">';
	jiazaihtml += '				<circle stroke-opacity=".5" cx="18" cy="18" r="18" />';
	jiazaihtml += '				<path d="M36 18c0-9.94-8.06-18-18-18">';
	jiazaihtml += '					<animateTransform attributeName="transform" type="rotate" from="0 18 18" to="360 18 18" dur="1s" repeatCount="indefinite" />';
	jiazaihtml += '				</path>';
	jiazaihtml += '			</g>';
	jiazaihtml += '		</g>';
	jiazaihtml += '	</svg>';
		...
		init: function(element, options) {
			...
			this.options = $.extend(true, {
				...
				up: {
					...
					show: false,
					contentinit: jiazaihtml,
					contentdown: '上拉显示更多',
					contentrefresh: jiazaihtml,
