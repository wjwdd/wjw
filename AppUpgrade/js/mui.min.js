...
//			function plusReady(){
//				
//				var hht=document.querySelector('#header');
//				var cjs = document.querySelector('.cjs');
//				if(hht&&cjs){
//					hht.style.height=44+plus.navigator.getStatusbarHeight()+'px';
//					hht.style.paddingTop=plus.navigator.getStatusbarHeight()+'px';
//		//			var cjs=document.createElement('div');
//					plus.navigator.setStatusBarStyle('dark');
//					cjs.style.marginTop = plus.navigator.getStatusbarHeight() + 'px';
//				}
//			}
			//gundong
			var allheight=document.querySelector('.allheight');
			if(allheight){
			
				allheight.style.minHeight=window.innerHeight+15+'px';
